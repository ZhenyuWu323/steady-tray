...
from .steady_tray_marl_env_cfg import SteadyTrayMarlEnvCfg


class SteadyTrayMarlEnv(DirectMARLEnv):
    cfg: SteadyTrayMarlEnvCfg

    def __init__(self, cfg: SteadyTrayMarlEnvCfg, render_mode: str | None = None, **kwargs):
