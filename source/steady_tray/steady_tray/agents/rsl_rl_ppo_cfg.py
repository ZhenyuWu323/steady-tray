...
@configclass
class G1ResidualRunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 50000
    save_interval = 100
    experiment_name = "g1_residual"
    empirical_normalization = False
    # residual whole body policy
    residual_whole_body_policy = RslRlResidualActorCriticCfg(
        init_noise_std=0.3,
        actor_hidden_dims=[512, 256, 128],
        critic_hidden_dims=[512, 256, 128],
        encoder_d_model=32,
